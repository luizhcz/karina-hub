...
public class AgentCrudTests(IntegrationWebApplicationFactory factory)
{
    ...
    public async Task Post_CriaAgente_Retorna201()
    {
        ...
        var response = await _client.PostAsJsonAsync("/api/aihub/agents", BuildPayload(id));
    ...
    public async Task Get_AgenteExistente_Retorna200()
    {
        ...
        var response = await _client.GetAsync($"/api/aihub/agents/{id}");
    ...
    {
        var response = await _client.GetAsync("/api/aihub/agents/agent-nao-existe-xyz-999");
    ...
    public async Task Put_AtualizaAgente_PreservaId()
    {
        ...
        var response = await _client.PutAsJsonAsync($"/api/aihub/agents/{id}", updated);
    ...
    public async Task Delete_AgenteExistente_Retorna204()
    {
        ...
        var response = await _client.DeleteAsync($"/api/aihub/agents/{id}");
