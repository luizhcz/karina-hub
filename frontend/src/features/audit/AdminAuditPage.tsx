...
const ACTION_COLOR: Record<string, 'green' | 'yellow' | 'red' | 'blue' | 'purple'> = {
  ...
  'agent.enabled_changed': 'purple',
  'agent.draft_created': 'yellow',
  'agent.draft_updated': 'yellow',
  'agent.draft_deleted': 'red',
  'agent.draft_submitted': 'blue',
  'agent.draft_approved': 'green',
  'agent.draft_rejected': 'red',
...
const ACTION_FILTER_OPTIONS: { value: string; label: string }[] = [
  ...
  { value: 'agent.enabled_changed', label: 'agent.enabled_changed' },
  { value: 'agent.draft_created', label: 'agent.draft_created' },
  { value: 'agent.draft_updated', label: 'agent.draft_updated' },
  { value: 'agent.draft_deleted', label: 'agent.draft_deleted' },
  { value: 'agent.draft_submitted', label: 'agent.draft_submitted' },
  { value: 'agent.draft_approved', label: 'agent.draft_approved' },
