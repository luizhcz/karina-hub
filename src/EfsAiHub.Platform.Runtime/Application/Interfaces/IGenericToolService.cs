...
/// e timeout ceiling, normaliza GET → InputContentType=None.
/// </summary>
public interface IGenericToolService
{
    Task<GenericTool> CreateAsync(string? id, GenericTool draft, CancellationToken ct = default);
    ...
    /// Owner gate por ProjectId. Re-roda invariantes + ceiling.
    /// </summary>
