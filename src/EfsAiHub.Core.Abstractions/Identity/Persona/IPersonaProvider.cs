...
/// retornar <see cref="UserPersona.Anonymous"/>. Fallback silencioso é
/// responsabilidade do próprio provider HTTP — decorators de cache não
/// precisam saber de política de recovery.
/// </summary>
