...
///
/// Nota pós-F4/ADR 003: isolamento de dados é feito por <b>ProjectId</b>
/// (ver <c>IProjectContextAccessor</c>). <c>TenantId</c> fica como dimensão
/// analítica em <c>admin_audit_log</c> + billing agregado cross-project, não
/// é usado em <c>HasQueryFilter</c>.
/// </summary>
